...
<template>
  <div id="app">
    ...
    <span v-if="!$root.store.username">
        <b-navbar toggleable="lg" type="dark" variant="dark">
            ...
            <!-- <router-link :to="{ name: 'main' }">Vue Recipes</router-link> -->
                <p class="h3 mb-2"><b-icon icon="house-door-fill" style="color: #6fa86a;"></b-icon></p>
            </b-navbar-brand>
            ...
            <b-collapse id="nav-collapse" is-nav>
                ...
                <b-navbar-nav>
                    <b-nav-item router-link :to="{ name: 'register' }"><b-icon icon="person-plus" style="color: #6fa86a;"></b-icon>   Register  </b-nav-item>
                ...
                <b-navbar-nav>
                    ...
                    <b-nav-item router-link :to="{ name: 'login' }" ><b-icon icon="box-arrow-in-right" style="color: #6fa86a;"></b-icon>   Login   </b-nav-item>
                </b-navbar-nav>
        ...
        <b-navbar toggleable="lg" type="dark" variant="dark">
            ...
            <b-collapse id="nav-collapse" is-nav>
                ...
                <b-navbar-nav>
                    ...
                    <b-nav-item @click="Logout"><b-icon icon="box-arrow-left" style="color: #6fa86a;"></b-icon> Logout</b-nav-item>
                </b-navbar-nav>
            </b-collapse>
        </b-navbar>
    </span>
    ...
    <!-- <div id="nav">
      ...
      <span v-else>
        {{ $root.store.username }}: 
        <router-link :to="{ name: 'myFavoriteRecipes' }">favorite recipes</router-link>|
